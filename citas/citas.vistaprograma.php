			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2>
			         ...
			         <li class="glyphicon glyphicon-calendar"></li> <i class="glyphicon glyphicon-user" ></i> <strong>Asignar Citas Programadas</strong>  
			         </h2>
				</div>
				<div class="panel-body form-inline">
					<div class="form-group">
						<b>Nro Celular:</b><br>
						<input type="number"  name="celular" id="celular"  class="form-control" placeholder="Celular registrado" onchange="xajax_Traenom2(this.value)">
					</div>
					<div class="form-group">
                        <b>Nombres:</b><br>
                        <input type="text"  name="nomape" id="nomape" class="form-control"  placeholder=" Nombre,apellidos o apodo"  > 
                     </div>
                     <div class="form-group">
                        <b>Fecha:</b><br>
                        <input type="date"  name="fechacita" id="fechacita" class="form-control"  value="<?php echo date('Y-m-d');?>" min="<?php echo date('Y-m-d');?>" onchange="xajax_hora(this.value)"> 
                     </div> 
                     <div class="form-group">
                     	 <b>Hora:</b><br>
                     	<select name="hora" id="hora" class="form-control">
                     		<option value="">Seleccione Una fecha diferente a hoy</option>
                     	</select>	
                     </div>	

                     <div class="form-group">
                     	<br>
                     	 <span class="btn btn-success" id="btn-crear" onClick="btn_asigcitapro()" >
