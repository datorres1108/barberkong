...
function BtnGuardarCli()
{
  var celular = document.getElementById('celular').value;
  var nomape = document.getElementById('nomape').value;
  var email = document.getElementById('email').value;
  var fcdia = document.getElementById('fcdia').value;
  var fcmes = document.getElementById('fcmes').value;
  xajax.call('GuardaCliente',{parameters:[celular,nomape,email,fcdia,fcmes],mode:'synchronous'});
}

function BtnEditGuardarCli()
{
  var edit_celular = document.getElementById('edit_celular').value;
  var edit_nomape = document.getElementById('edit_nomape').value;
  var edit_email = document.getElementById('edit_email').value;
  var edit_fcdia = document.getElementById('edit_fcdia').value;
  var edit_fcmes = document.getElementById('edit_fcmes').value;
  var estado = document.getElementById('estado').value;
  var documento = document.getElementById('cel').value;
  xajax.call('GuardaEditCliente',{parameters:[edit_celular,edit_nomape,edit_email,edit_fcdia,edit_fcmes,estado,documento],mode:'synchronous'});
}

function BtnConsultarCli()
{
  var cel = document.getElementById('cel').value;
  xajax.call('ConsulCliente',{parameters:[cel],mode:'synchronous'});
}

function BtnConsultarEditCli()
{
  var cel = document.getElementById('cel').value;
  xajax.call('ConsulEditCliente',{parameters:[cel],mode:'synchronous'});
}

function ValidoDocu(cel){
  xajax.call('ValidoDocu',{parameters:[cel],mode:'synchronous'});
}